                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <form method="post" action="{{ '/admin/'.$d->nsoId}}">
                            							{{ csrf_field() }}
                            							{{ method_field('DELETE') }}
                                          <button style="margin-bottom: 2px; display: block; width: 100px;" type="submit" class="btn btn-danger btn-xs"> Delete </button>
                                        </form>
                                        <form method="get" action="{{url('/admin/'.$d->nsoId.'/edit')}}">
                                          <button style="margin-bottom: 2px; display: block; width: 100px;" type="submit" class="btn btn-warning btn-xs"> Edit </button>
                                        </form>
                                      </td>
                                    </tr>
                                    @endforeach
