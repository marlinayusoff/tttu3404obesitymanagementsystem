          ...
          <section class="wrapper">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 mb">
              <div class="product-panel-2 pn" style="height: 355px;"><br/>
                ...
                <a class="btn btn-small btn-theme04" href="/admin/food">Foods</a>
                          <a class="btn btn-small btn-theme04" href="/admin/drink">Drinks</a>
                          <a class="btn btn-small btn-theme04" href="/admin/activity">Activities</a>
              </div>
            </div>
