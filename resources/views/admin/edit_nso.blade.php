										...
										<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
										  ...
										  <div class="col-md-6 inputGroupContainer">
										  	<div class="input-group">
										  		...
										  		<input name="name" placeholder="name" class="form-control" value="{{ $item->name }}" type="text" required autofocus>
										  		@if ($errors->has('name'))
										  ...
										  <label class="col-md-4 control-label" >Gender</label>
										    <div class="col-md-6 inputGroupContainer">
										    	<div class="input-group">
						                            ...
						                            <input name="gender" placeholder="gender" class="form-control" value="{{ $item->gender }}" type="text" readonly required>
					                            </div>
					                        </div>
										</div>
										    ...
										    <div class="col-md-6 inputGroupContainer">
											    <div class="input-group">
											        <span class="input-group-addon"><i class="glyphicon glyphicon-tag"></i></span>
												  	<input type="text"  class="form-control" name="mycard" id="id_mycard" value="{{ $item->icNo }}" required pattern="[0-9]{2}(0[1-9]|1[0-2])(0[1-9]|1[0-9]|2[0-9]|3[01])(0[1-9]|1[0-6])[0-9]{4}" readonly required>
											  	</div>
											</div>
										</div>
										<!-- Alamat-->
										    ...
										    <div class="col-md-6 inputGroupContainer">
											    <div class="input-group">
											        <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
											  		<input name="address" placeholder="address" class="form-control" value="{{ $item->address }}" type="text"  required>
										    ...
										    <div class="col-md-6 inputGroupContainer">
											    <div class="input-group">
											        <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
												  	<input type="text" class="form-control" name="telNo" value="{{ $item->telNo }}" placeholder="No.Tel" required>
												  	@if ($errors->has('telNo'))
					                                    <span class="help-block">
										    ...
										    <div class="col-md-6 inputGroupContainer">
											    <div class="input-group">
											        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
												  	<input type="email" class="form-control" name="email"  value="{{ $item->email }}" placeholder="Emel" required>
											  	</div>
											</div>
										</div>
										<!-- Id-->
										    ...
										    <div class="col-md-6 inputGroupContainer">
											    <div class="input-group">
											    	<span class="input-group-addon"><i class="glyphicon glyphicon-text-width"></i></span>
												  	<input type="text"  class="form-control" name="username" value="{{ $item->username }}" placeholder="Id" required>
											  	</div>
											</div>
										</div>
										<!-- kata laluan-->
