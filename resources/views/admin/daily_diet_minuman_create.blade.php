              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a href="/admin/drink">Drinks</a></li>
								...
								<tfoot>
									<tr>
										<td colspan="3" style="text-align:center">
											...
											<a id="cancel2" class="btn btn-danger" href="/admin/drink">Cancel <i class="fa fa-times"></i></a>
										</td>
									</tr>
								</tfoot>
							</table>
...
<script type="text/javascript">
  var tr1 = $('#table2 tbody tr').length;
  	$('#add2').on('click',function() {
  		var newRow = "<td><div class='form-group'><div class='col-md-12 inputGroupContainer'><div class='input-group'><span class='input-group-addon'><i class='glyphicon glyphicon-pencil'></i></span><input name='drinkName[]' class='form-control' type='text-center' style='text-align: center;'></div></div></div></td><td><div class='form-group'><div class='col-md-12 inputGroupContainer'><div class='input-group'><span class='input-group-addon'><i class='glyphicon glyphicon-pencil'></i></span><input  name='drinkCalories[]' class='form-control' type='text-center' style='text-align: center;''></div></div></div></td>";
  	var tableRow1 = $('#table2 tbody tr').length;
  		tableRow1++;
  		$('#table2').append("<tr><th scope='row'>"+tableRow1+"</th>"+newRow);
