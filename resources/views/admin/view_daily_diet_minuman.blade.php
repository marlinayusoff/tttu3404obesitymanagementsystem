...
<section id="container" >
	...
	<section id="main-content">
		...
		<div class="row">
			...
			<h2>Daily Diet Library - Drinks</h2>
				...
				<div class="row" style="border:1px;"></div>
					...
					<form action="" method="post">
									...
									@foreach($data as $key => $p)
										...
										<td>
											<div class="form-group">
												<div class="col-md-12 inputGroupContainer">
													  ...
													  <input name="drinkName" class="form-control" type="text-center" style="text-align: center;" value="{{$p->drinkName}}" readonly />
												    </div>
												</div>
											</div>
										</td>
										...
										<td>
											<div class="form-group">
												<div class="col-md-12 inputGroupContainer">
												  	<div class="input-group">
													  <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
													  <input name="drinkCalories" class="form-control" type="text-center" style="text-align: center;" value="{{$p->drinkCalories}}" readonly/>
												    </div>
												</div>
											</div>
										</td>
					                    <td>
					                       <div class="pull-right hidden-phone">
											...
											<form method="post" class="testbuang" action="{{ '/admin/drink/'.$p->drinkId}}" style="float: left;margin-left: 5px;">
											    {{ csrf_field() }}
                            					{{ method_field('DELETE') }}
						...
						<a role="button" type="submit" style="margin-left: 5px;" class="btn btn-success pull-right" href="/admin/drink/new">Add Drink <span class="glyphicon glyphicon-plus"></span> </a>
