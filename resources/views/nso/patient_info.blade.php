...
<?php $user = Session::get('user'); ?>
    ...
    <a href="/schedule/{{ $data->patientId }}" class="btn btn-round btn-theme02" style="width: 45px;padding: 12px;"><i class="fa fa-calendar "></i></a>
									...
									<div class="form-group">
										...
										<div class="col-md-6 inputGroupContainer">
    <a href="/getDailyDietDetails" class="btn btn-round btn-theme03" style="width: 45px;padding: 12px;"><i class="fa fa-book "></i></a>
										 </div>
									</div>
									<!-- Button -->
									<div class="form-group">
