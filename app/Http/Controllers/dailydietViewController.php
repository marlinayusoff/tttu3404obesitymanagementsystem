...
foreach ($dailydiet_details as $d) {	
										...
										<td style="background-color: #fff;">'.$d->foodCalories.'</td>
										</tr>';
										$food += $d->foodCalories;
}
...
foreach ($dailydiet_details as $d) {
										...
										<td style="background-color: #fff;">'.$d->drinkCalories.'</td>
										</tr>';
										$drink += $d->drinkCalories;
}
...
foreach ($dailydiet_details as $d) {
										...
										<td style="background-color: #fff;">'.$d->activityCalories.'</td>
										</tr>';
										$activity += $d->activityCalories;
}
    									$grandtotal += $drink + $food - $activity;
											...
											<td style="background-color: #fff;"><font color="green" size="3" style="bold">'.$grandtotal.'Kcal</td>
										</tr>
										</thead>
									</table>
								  </form>';
