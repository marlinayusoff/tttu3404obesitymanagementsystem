...
class patientSummaryController extends Controller
{
    public function show(){
    	...
    	//total patient
    	$female = Patient::where('gender', 'like', 'Female')->count();
		$male = Patient::where('gender', 'like', 'Male')->count();
		$total = Patient::count();
